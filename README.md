...
插件原作者已不再维护此插件，现在一个组织ctrlpvim，fork了一个新的仓库来维护，我的翻译的pr已经被merge，建议使用新地址

* [原项目的github地址（不再维护）](https://github.com/kien/ctrlp.vim)
* [ctrlpvim维护的github地址](https://github.com/ctrlpvim/ctrlp.vim)
